...
<section class="main">
    ...
    <div class="content px-5 py-4">
        <h3 class="av_heading text-center">How To Use This Book</h3>
        <form action="{{route('howToUseDetail')}}" method="post" id="howToUseForm" class="pt-3">
            ...
            <div class="mt-4">
                ...
                <div class="mt-3">
                    <div id="editor2"><?php echo $bookdata['how_to_use'] ?? '' ?></div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#howToUseForm").submit(function(e) {
            e.preventDefault();
            validation = validateForm();
            if (validation) {
                var content = CKEDITOR.instances['editor2'].getData();
                $('#contentInput').val(content);
                $("#howToUseForm")[0].submit();
            } else {
                swal({
        ...
        function validateForm() {
            let errorCount = 0;
            $("form#howToUseForm :input").each(function() {
                let val = $(this).val();
